                    ...
                    @endif
                      <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                        <div class="flex justify-end mb-4">
                            ...
                            <button onclick="location.href='{{ route('admin.owners.create') }}'" type="submit" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">新規登録</button>                        
                        </div>
                        <table class="table-auto w-full text-left whitespace-no-wrap">
                          ...
                          <tbody>
                            ...
                            <form id="delete_{{ $owner->id }}" method="POST" action="{{ route('admin.owners.destroy', ['owner' => $owner->id ]) }}">
                              ...
                              @method('delete')
                            <td class="w-28">
                              <a href="#" data-id="{{ $owner->id }}" onclick="deleteButton(this)" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded ">削除</button>                                                      
                            </td>
                            </form>
                          </tr>
                              @endforeach 
